<div class="con">
  ...
  <form id="edit" name="edit" action="/edit">
    <input name="title" type="text" class="title" placeholder="제목을 입력해주세요." value='<?= $title ?>'>
    <textarea name="contents" type="text" class="contents" placeholder="내용을 입력해주세요"><?= $contents ?></textarea>
    <button>수정하기</button>
  </form>
</div>
