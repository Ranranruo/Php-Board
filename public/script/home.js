...
async function fetchPost() {
  ...
  const res = await fetch(`/posts?search=${Search}&input=${Input}&sortkey=${Sort}`);
  ...
  data.map((item) => {
    ...
    Li.innerHTML =
      `
    <a href="/view/${item.idx}">
    <div class="data">
    <div class="up">
    <svg xmlns="http://www.w3.org/2000/svg" height="16" width="12" viewBox="0 0 384 512"><!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
    ...
    <h2 class="content">${item.contents}</h2>
    </div>
    </div>
    <div class="detail">
    <div class="user">
    ...
    <svg xmlns="http://www.w3.org/2000/svg" height="16" width="20" viewBox="0 0 640 512"><!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
